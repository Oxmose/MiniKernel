 ...
 * Version: 1.0
 *
 * Boot code for the PowerPC e200 version of MiniKernel
 ******************************************************************************/

#include "output.h"       /* output_string */
#include "qemu-ppce200.h" /* CONFIG_SYS_CCSRBAR_PHYS, CONFIG_SYS_CCSRBAR */
...
{
    bsp_init();
    output_str("BSP Initialized, jumping to main\n", SERIAL);
