...
#define MSR_UCLE	(1<<26)		/* User-mode cache lock enable (e200) */
#define MSR_VEC		(1<<25)		/* Enable AltiVec(74xx) */
#define MSR_SPE		(1<<25)		/* Enable SPE(e200) */
...
#define MSR_UBLE	(1<<10)		/* BTB lock enable (e200) */
...
#define MSR_PMM		(1<<2)		/* Performance monitor mark bit (e200) */
...
#endif
#if defined(CONFIG_E200) || defined(CONFIG_MPC86xx)
#define PIR	SPRN_PIR
#endif
...
#define PVR_VER_E200_V1	0x8020
#define PVR_VER_E200_V2	0x8021
#define PVR_VER_E200MC	0x8023
